"""
Django settings for ch_capacity_backend project.
...
ROOT_URLCONF = 'ch_capacity_backend.urls'
...
WSGI_APPLICATION = 'ch_capacity_backend.wsgi.application'
...
# Fix no key error (google storage)
try:
